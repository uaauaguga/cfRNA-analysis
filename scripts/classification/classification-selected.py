...
train_ids = np.array(list(pos_ids_train)+list(neg_ids_train))[train_index]
...
test_ids = np.array(list(pos_ids_test)+list(neg_ids_test))[test_index]
...
prob.loc[sample_ids,"probability"]=y_pred
...
y_pred = prob.loc[test_ids,"probability"]
